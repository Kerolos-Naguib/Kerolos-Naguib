## Hey, [Kerolos Naguib!](https://github.com/Kerolos-Naguib) <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="28px" height="28px">
...
class WhoAmI:
    user = 'Kerolos Naguib'
    current_focus = 'Cybersecurity'
    future_specialization = 'Cloud Security'
    ...
    def Ambitions():
        BuildCybersecuritySkills()
        ImproveProblemSolving()
        MasterLinuxAndNetworking()
        SpecializeInCloudSecurity()
```
...
[![TryHackMe](https://img.shields.io/badge/-SpectreX01-red?style=flat-square\&logo=tryhackme\&logoColor=white)](https://tryhackme.com/p/SpectreX01)
...
* ✅ **Cybersecurity Certificate — Udemy**
* ✅ **AI For Everyone — ITI**
* 📚 **CompTIA A+ Course — Samih Ramadan**
